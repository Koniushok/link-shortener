...
import {
  authRequest, authSuccess, authError, authDisable, type Login,
} from '../actions/auth';
import { LOGIN, LOGOUT, UNAUTHORIZED_ERROR_401 } from '../constants/actionTypes';
import {
...
export default function* watchAuth(): any {
  ...
  yield all([takeLatest(LOGIN, authorize), takeLatest([LOGOUT, UNAUTHORIZED_ERROR_401], logout)]);
}
